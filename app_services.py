...
def _execute_job_headless(job: dict, api_key: str) -> bool:
    ...
    try:
        ...
        request = RunRequest(
            ...
            college_house_institution=payload.get("college_house_institution") or None,
            college_house_ipeds=payload.get("college_house_ipeds"),
            college_house_properties=payload.get("college_house_properties") or [],
            college_house_base_variant_only=payload.get("college_house_base_variant_only", False),
